...
Locale['es'] = { -- es (to be update)
    success_bought_shell = 'Compraste una chasis de vehículo (Plano de construcción)',
	  install_engine = 'Tienes que instalar el motor antes de continuar',
	  install_tranny = 'Tienes que instalar el sistema de transmision',
    install_brake = 'Tienes que instalar los frenos',
    install_seat = 'Debes de montar los asientos del vehiculo antes de continuar',
    far_away = 'Estas muy lejos del vehículo',
    partscancel = 'Se ha cancelado la instalación de la piezas.',
    installsuccess = 'La pieza fue instalada correctamente',
    already_install = 'Esta pieza ya esta instalada',
    not_inzone = 'La construcción de vehiculos solo está disponible en Zonas de Construccion',
    receive_shell_chop = 'Has recibido el chasis de un vehiculo',
    alreadygarage = 'Ya eres propietario de un garaje',
    notenoughmoney = 'No tienes suficiente dinero',
    partnotmatched = 'Esta pieza no encaja en este modelo de vehículo',
    cardeleted = 'El projecto del vehiculo fue eliminado',
    noperms = 'No tienes permisos para eliminar este vehículo',
    orderlistrefresh = ' La lista de ordenm de trabajo a sido reiniciada',
    cantrelease = 'No tienes stock para este modelo de vehículo',
    novehiclesingarage = 'El garaje está vacio',
    orderjobrelease = 'Has terminado la entrega del vehículo - Te han pagado ',
}
